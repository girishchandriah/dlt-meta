...
This demo showcases DLT-META's capabilities of creating landing and refinery Lakeflow Declarative pipeline with initial and incremental mode automatically.
...
- Runs landing and refinery Lakeflow Declarative Pipeline for incremental load for CDC events

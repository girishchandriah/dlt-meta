...
class TablePreCreator:
    ...
    def ensure_table_exists(self, dataflow_spec, layer_type: str) -> None:
        ...
        # DLT needs to manage CDC tables from the start for LIVE. syntax to work properly
        if hasattr(dataflow_spec, 'cdcApplyChanges') and dataflow_spec.cdcApplyChanges:
            self.logger.info(
                ...
                f"because CDC apply changes is configured. DLT will create and manage this table."
            )
            return
